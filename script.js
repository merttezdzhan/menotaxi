const translations = {
    nl: {
        ...
        about_text: "Welkom bij Meno Taxi, dé taxicentrale voor Utrecht en omstreken. Met jarenlange ervaring in de branche staan wij garant voor veilig, comfortabel en stipt personenvervoer. Ons wagenpark bestaat uit moderne, schone voertuigen en onze chauffeurs zijn vakkundig, representatief en klantvriendelijk. Of u nu op zoek bent naar een snelle rit naar het station, zakelijk vervoer op maat, of een ontspannen begin van uw vakantie via onze luchthavenservice; bij Meno Taxi bent u altijd in goede handen.",
    ...
    en: {
        ...
        about_text: "Welcome to Meno Taxi, the taxi center for Utrecht and the surrounding area. With years of experience in the industry, we guarantee safe, comfortable, and punctual passenger transport. Our fleet consists of modern, clean vehicles, and our drivers are skilled, presentable, and customer-friendly. Whether you are looking for a quick ride to the station, tailored business transport, or a relaxing start to your holiday via our airport service; with Meno Taxi, you are always in good hands.",
